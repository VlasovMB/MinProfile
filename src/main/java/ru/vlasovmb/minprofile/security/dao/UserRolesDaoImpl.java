...
public class UserRolesDaoImpl implements UserRolesDao {
    ...
    public void setDataSource(final DataSource dataSource) {
        ...
        simpleInsert = new SimpleJdbcInsert(dataSource).withTableName(TABLE_NAME_USER_ROLES).usingGeneratedKeyColumns("id");
    }
    ...
    public Iterable<Role> getUserRoles(User user) {
        ...
        return namedParameterJdbcTemplate
                .queryForStream(SQL_STRING,namedParameters, UtilDaoSecurity.getRoleRowMapper())
